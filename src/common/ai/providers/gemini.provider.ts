...
- social_summary: Емкая, вдохновляющая фраза для соцсетей (до 100 символов). Без лишних слов, максимально точно и красиво.
...
Выдай ответ СТРОГО в формате JSON, где каждое значение — это ОДНА ПЛОСКАЯ СТРОКА (string) на языке ${languageName}:
{
  ...
  "social_summary": "Короткая, яркая фраза для карточки в соцсетях",
