...
Стиль и Структура:
- Тон: Академичный, уважительный. Будь максимально лаконичен, избегай "воды" и длинных вступлений.
- short_meaning: Предельно сжатая суть (1 предложение).
- long_meaning: Развернутое, но компактное объяснение. Пиши емко, используй короткие абзацы.
